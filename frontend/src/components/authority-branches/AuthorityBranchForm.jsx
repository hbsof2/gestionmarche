      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[92vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1.5">
                الرقم الإحصائي (NIS) <span className="text-slate-400 font-normal">(اختياري)</span>
              </label>
              <input
                type="text"
                dir="ltr"
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1.5">
                الرقم الجبائي (NIF) <span className="text-slate-400 font-normal">(اختياري)</span>
              </label>
              <input
                type="text"
                dir="ltr"
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1.5">
              رقم السجل التجاري (RC) <span className="text-slate-400 font-normal">(اختياري)</span>
            </label>
            <input
              type="text"
              dir="ltr"
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1.5">
              تاريخ السجل التجاري <span className="text-slate-400 font-normal">(اختياري)</span>
            </label>
            <div className="grid grid-cols-3 gap-2">
              <select
                value={rcDay}
                onChange={(e) => setRcDay(parseInt(e.target.value, 10))}
                className="w-full px-2 py-2.5 rounded-lg border border-slate-200 bg-slate-50 text-sm outline-none focus:bg-white transition-colors"
              >
