    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center px-4">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">لا توجد فروع للمصلحة المتعاقدة</p>
        ...
        <div className="overflow-x-auto w-full">
          <table className="table-fixed w-full min-w-full text-sm min-w-[640px]">
            ...
            <tbody className="divide-y divide-slate-50 dark:divide-slate-700">
              {branches.map((b) => (
                <tr key={b.id} className="hover:bg-slate-50/60 dark:hover:bg-slate-700/60 transition-colors border-b border-slate-100 dark:border-slate-700">
                  ...
                  <td className="w-28 px-3 py-3 text-right whitespace-nowrap overflow-hidden text-ellipsis font-medium text-sm text-slate-800 dark:text-slate-100 hidden md:table-cell">{b.wilaya}</td>
                  <td className="w-28 px-3 py-3 text-right whitespace-nowrap overflow-hidden text-ellipsis font-medium text-sm text-slate-800 dark:text-slate-100 hidden lg:table-cell">{b.commune}</td>
                  <td className="w-32 px-3 py-3 text-right whitespace-nowrap overflow-hidden text-ellipsis font-medium text-sm text-slate-800 dark:text-slate-100 hidden sm:table-cell" dir="ltr">{b.phone}</td>
                  <td className="w-32 px-3 py-3 text-right whitespace-nowrap overflow-hidden text-ellipsis font-medium text-sm text-slate-800 dark:text-slate-100 hidden lg:table-cell" dir="ltr">{b.nis}</td>
