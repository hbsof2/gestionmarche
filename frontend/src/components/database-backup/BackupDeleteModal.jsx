...
export default function BackupDeleteModal({ backup, onConfirm, onCancel }) {
    ...
    <div className="fixed inset-0 bg-black/50 dark:bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-sm">
        <div className="p-6 text-center">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-1">هل أنت متأكد من حذف النسخة الاحتياطية:</p>
          <p className="text-sm font-bold text-slate-800 dark:text-slate-100 mb-2" dir="ltr">&quot;{backup.filename}&quot;</p>
